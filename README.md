...
> **Status: `0.0.17` — Phase 3 (build + drive).** 18 tools: build_tree / edit_tree (incl. add/remove options & outcomes) / build_control_panel / export_tree_json / import_tree_json, read + roll + verify, run_scenarios (what-if comparison), plus run_evpi / run_evii / run_risk_profile / run_robustness / run_sensitivity / run_decision_report / run_analysis / read_sheet over ModelChoice's headless commands.
